class Scholarship {
  ...
  factory Scholarship.initial() => Scholarship(
    ...
    achievedCertificate: 'achieved_certificate',
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'type_of_financing': this.typeOfFinancing,
      'funding_agency': this.fundingAgency,
      'achieved_certificate': this.achievedCertificate,
      'required_documents': this.requiredDocuments,
      'advantages': this.advantages,
      'required_certificates': this.requiredCertificates,
  ...
  factory Scholarship.fromMap(Map<String, dynamic> map) {
    return Scholarship(
      ...
      typeOfFinancing: map['type_of_financing'] ??'',
      fundingAgency: map['funding_agency'] ??'',
      achievedCertificate: map['achieved_certificate'] ??'',
      requiredDocuments: map['required_documents'] ??'',
      advantages: map['advantages']??'',
      requiredCertificates: map['required_certificates'] ??'',
      submissionTime: map['submission_time'] ??'',
